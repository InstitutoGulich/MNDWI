...
path = "/home/jrubio/Documentos/VENVS/SANCOR4/indices/mndwi/"#indices/mndwi/" #Ruta de los archivos MNDWI
...
for pais in paises:
	...
	os.system('python3 main_drive.py %s %s %s'%(pcPath,drivePath,dwnldDate))
